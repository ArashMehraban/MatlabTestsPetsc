function f0 = LinElas_force_MMS(xe,phys)
   ...
   % RHS:
    ...
    g2=(-(E.*(cos(y.*3.0).*cos(z.*4.0).*exp(x.*2.0).*3.0-cos(x.*2.0).*sin(z.*4.0).*exp(y.*3.0).*2.0).*(nu-1.0./2.0))./((nu.*2.0-1.0).*(nu+1.0))+(E.*(cos(x.*2.0).*sin(z.*4.0).*exp(y.*3.0).*8.0+sin(x.*2.0).*sin(y.*3.0).*exp(z.*4.0).*6.0).*(nu-1.0./2.0))./((nu.*2.0-1.0).*(nu+1.0))+(E.*nu.*cos(y.*3.0).*cos(z.*4.0).*exp(x.*2.0).*6.0)./((nu.*2.0-1.0).*(nu+1.0))-(E.*nu.*sin(x.*2.0).*sin(y.*3.0).*exp(z.*4.0).*1.2e+1)./((nu.*2.0-1.0).*(nu+1.0))-(E.*cos(x.*2.0).*sin(z.*4.0).*exp(y.*3.0).*(nu-1.0).*9.0)./((nu.*2.0-1.0).*(nu+1.0)));
    g3=(-(E.*(cos(x.*2.0).*cos(z.*4.0).*exp(y.*3.0).*6.0-cos(y.*3.0).*sin(x.*2.0).*exp(z.*4.0).*(9.0./2.0)).*(nu-1.0./2.0))./((nu.*2.0-1.0).*(nu+1.0))+(E.*(cos(y.*3.0).*sin(x.*2.0).*exp(z.*4.0).*2.0+sin(y.*3.0).*sin(z.*4.0).*exp(x.*2.0).*4.0).*(nu-1.0./2.0))./((nu.*2.0-1.0).*(nu+1.0))+(E.*nu.*cos(x.*2.0).*cos(z.*4.0).*exp(y.*3.0).*1.2e+1)./((nu.*2.0-1.0).*(nu+1.0))-(E.*nu.*sin(y.*3.0).*sin(z.*4.0).*exp(x.*2.0).*8.0)./((nu.*2.0-1.0).*(nu+1.0))-(E.*cos(y.*3.0).*sin(x.*2.0).*exp(z.*4.0).*(nu-1.0).*1.6e+1)./((nu.*2.0-1.0).*(nu+1.0)));
